            ...
            <table class="table table-condensed">
                <thead>
                    <tr>
                        ...
                        <th class="text-right">{{ __('product.pcs_price') }}</th>
                        <th class="text-right">{{ __('product.dozen_price') }}</th>
                        <th class="text-right">{{ __('product.pack_price') }}</th>
                        <th class="text-right">{{ __('product.box_price') }}</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">{{ format_rp($product->pcs_price) }}</td>
                        <td class="text-right">{{ format_rp($product->dozen_price) }}</td>
                        <td class="text-right">{{ format_rp($product->pack_price) }}</td>
                        <td class="text-right">{{ format_rp($product->box_price) }}</td>
